...
# Plot the buffers as circles and bees as points to improve visualization
ggplot() +
  geom_sf(data = buffer_500, fill = NA, color = "skyblue", lwd = 1) +
  geom_sf(data = buffer_750, fill = NA, color = "orange", lwd = 1) +
  geom_sf(data = buffer_1000, fill = NA, color = "green", lwd = 1) +
  geom_sf(data = spirit_bee_sf, aes(color = "Bees"), size = 2, alpha = 0.7) +
  labs(
    title = "Bee Locations and Buffers",
    subtitle = "500 km, 750 km, and 1000 km Buffers Around Bee Locations",
    color = "Legend"
  ) +
  theme_minimal() +
  theme(legend.position = "bottom") +
  scale_color_manual(values = c("Bees" = "black"))
```